...
try
{
    ...
    $InstallFeature =   (Get-WindowsFeature -Name Telnet-Client,File-Services,Failover-Clustering,RSAT-Clustering-AutomationServer,RSAT-Clustering-PowerShell,RSAT-Clustering-CmdInterface,RSAT-AD-PowerShell,RSAT-Clustering-Mgmt | where InstallState -ne Installed).name
